Feature: Find Transactions in Account Activity
  ...
  Background:
    ...
    And Account Actitivty page is initialized
    And user navigates to the "Account Activity" page
  ...
  Scenario: Search description case insensitive
    ...
    Scenario: Type
      ...
      And clicks search
      Then results table should show "at least" 1 result under "Deposit"
      But results table should show "exactly" 0 result under "Withdrawal"
      When user selects type "Withdrawal"
      And clicks search
      Then results table should show "at least" 1 result under "Withdrawal"
      But results table should show "exactly" 0 result under "Deposit"
